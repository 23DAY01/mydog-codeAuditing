# 项目文件夹的路径
project_path="/var/workplace/2023CISCN/2022CISCN/backend"
# 保存全部文件的文件夹路径
work_dir_path = '/var/workplace/2023CISCN/fuck'
# 保存单个文件的文件夹路径
single_dir_path = ''
# c文件编译依赖的目录路径，不存在则为''
support_dir_path = '/var/workplace/2023CISCN/Juliet/C/testcasesupport'
# llvm的安装路径
llvm_build = '/usr/lib/llvm-12'
# dg工具的路径
dg_tools_path = '/var/workplace/2023CISCN/dg/tools'
# c文件目录路径
src_dir_path = ""
'''
以下路径若无特殊需要，不必修改
